...
- `sorting_operation_counts.csv` records comparisons, swaps, writes, passes, partitions, and merges for complexity discussion.
...
- `graph_operation_counts.csv` records queue polls, edge checks, relaxations, and visited nodes for complexity discussion.
